...
export const Profile = () => {
  const user = {
    ...
    password: 'sho',
    nickname: 'Sho',
    hobbies: ['baseball', 'basketball', 'soccer', 'cooking', 'traveling', 'books'],
    ...
    selfIntro:
      'I rather like baseball than curry. I rather like baseball than curry. I rather like baseball than curry. I rather like baseball than curry. I rather like baseball than curry. I rather like baseball than curry. I rather like baseball than curry. I rather like baseball than curry.',
    likedNum: 0,
    isSecretMode: '',
  }
